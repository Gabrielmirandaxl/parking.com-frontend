...
# Gerenciamento de estacionamento (ESTACIONA.COM)
 ...
 O estaciona.com é um projeto que tem como objetivo ajudar no gerenciamento de veículos no estacionamento! O sistema foi desenvolvido em `javascript` utilizando `vuejs`.
...
$ git clone https://github.com/Gabrielmirandaxl/parking.com-frontend

# acesse a pasta do projeto
$ cd parking.com-frontend
...
## 🌐 aplicação
<img width="900" heigth="900"  src="https://github.com/Gabrielmirandaxl/gif/blob/main/2023-02-23%2020-42-03.gif">
